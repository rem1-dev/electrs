...
#[cfg_attr(feature = "tracing-enabled", instrument(skip_all, name="electrum_merkle::get_tx_merkleproof"))]
...
#[cfg_attr(feature = "tracing-enabled", instrument(skip_all, name="electrum_merkle::get_header_merkle_proof"))]
...
#[cfg_attr(feature = "tracing-enabled", instrument(skip_all, name="electrum_merkle::get_id_from_pos"))]
